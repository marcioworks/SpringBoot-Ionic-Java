...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtorRepository.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20,
		...
		Cliente cli1 = new Cliente(null, "Maria silva", "marcioworkar@gmail.com", "53423498843",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363327", "93838393"));

		Cliente cli2 = new Cliente(null, "Marcio silva", "marcioadsworks@gmail.com", "53983815049",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
